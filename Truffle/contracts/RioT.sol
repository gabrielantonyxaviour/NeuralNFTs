...
contract NeuralNFTs {
    ...
    function createDevice(
        ...
        bytes32 _neuralnftsHash = keccak256(
        ...
        validate(_entityId)
    {
        ...
        _device.neuralnftsHash = hashingHashes(
            _device.deviceId,
    ...
    function hashingHashes(
        ...
        return
            keccak256(
                abi.encodePacked(_deviceId, _manufacturerHash, _firmwareHash)
            );
    }
}
